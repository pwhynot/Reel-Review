...
const Home = () => {
  return (
    <div>
      <h4>Welcome to Reel Review, checkout some of our in house articles below. Be sure to sign up to become a member and start writting reviews today!</h4>
      <Col sm="6" >
      <Card>
        <CardImg top width="100%" imgSize="50%" src="http://www.ashartex.com/wp-content/uploads/2016/12/welcome-images-25.png" alt="Card image cap" />
        <CardBody>
